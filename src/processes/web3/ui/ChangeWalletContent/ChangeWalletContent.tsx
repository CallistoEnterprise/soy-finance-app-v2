    ...
    {step === 2 && <>
      {currentWallet === "walletConnect" && <>
        ...
        <div className={styles.pickNetworks}>
          <PickButton withCheckmark
                      onClick={() => wc2Blockchains.includes(820) ? disableWcBlockchainFn(820) : enableWc2BlockchainFn(820)}
                      isActive={wc2Blockchains.includes(820)}>
            <span className={styles.pickButtonContent}>Callisto Network</span>
          </PickButton>
          <PickButton withCheckmark
                      onClick={() => wc2Blockchains.includes(199) ? disableWcBlockchainFn(199) : enableWc2BlockchainFn(199)}
                      isActive={wc2Blockchains.includes(199)}>
            <span className={styles.pickButtonContent}>BitTorrent</span>
          </PickButton>
          <PickButton withCheckmark
                      onClick={() => wc2Blockchains.includes(61) ? disableWcBlockchainFn(61) : enableWc2BlockchainFn(61)}
                      isActive={wc2Blockchains.includes(61)}>
