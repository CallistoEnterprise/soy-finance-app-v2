...
import {PAIR_ABI, ERC_20_ABI, ROUTER_ABI, ERC_223_ABI, MASTERCHEF_ABI, LOCAL_FARM_ABI, LOCAL_FARM_V2_ABI} from "../constants/abis";
...
export const LOCAL_FARM_V2_INTERFACE = new Interface(LOCAL_FARM_V2_ABI);
